...
function nav(path) {
    ...
    <a href="https://www.youtube.com/@darkshadow4751" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'GoIndex Drive on Github'}">
